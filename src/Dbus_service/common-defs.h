...
#define VALUE_SERVICE_NAME        "com.actia.platform.fms"
/* Object path to the provided object. */
#define VALUE_SERVICE_OBJECT_PATH "/com/actia/platform/fms"
/* And we're interested in using it through this interface.
   This must match the entry in the interface definition XML. */
#define VALUE_SERVICE_INTERFACE   "com.actia.platform.fms"
